...
************************************************************************************/
    ...
    #include <glad/glad.h>      // GLAD extensions loading library, includes OpenGL headers
#endif
...
void rlLoadExtensions(void *loader)
{
    ...
    if (gladLoadGLLoader((GLADloadproc)loader) == 0) TRACELOG(RL_LOG_WARNING, "GLAD: Cannot load OpenGL extensions");
